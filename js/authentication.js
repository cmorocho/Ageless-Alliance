(function (jQuery, Firebase, Path) {
    ...
    var rootRef = new Firebase('https://ageless-link.firebaseapp.com');
    ...
    var routeMap = {
        ...
        '../user_accounts/account-official.html': {
            form: 'frmProfile',
            controller: 'profile',
    ...
    function routeTo(route) {
        window.location.href = '../login.html' + route;
    }
    ...
    Path.map("../login.html").to(prepRoute);
    Path.map("#/logout").to(prepRoute);
    Path.map("../signup.html").to(prepRoute);
    Path.map("../user_accounts/account-official.html").to(prepRoute);
